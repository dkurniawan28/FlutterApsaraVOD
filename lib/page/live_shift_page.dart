...
class _LiveShiftPageState extends State<LiveShiftPage> {
  var _url = "http://pull.livetest2.aliyunlive.com/demo_use/nochange.m3u8?lhs_start_human_s_8=20211118112200&aliyunols=on";
  var _timeLineUrl = "http://pull.livetest2.aliyunlive.com/openapi/timeline/query?aliyunols=on&app=demo_use&stream=nochange&format=ts";
  ...
  void initState() {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((timeStamp) {
      // final RenderBox containerRenderBox = _sliderDividerContainerKey.currentContext.findRenderObject();
      var scheduleForDayKey;
      final RenderBox containerRenderBox = scheduleForDayKey.currentContext!.findRenderObject() as RenderBox;
    ...
    _flutterAliLiveShiftPlayer = FlutterAliPlayerFactory.createAliLiveShiftPlayer(playerId: "aliLiveShiftPlayer");
    _initListener();
  }
