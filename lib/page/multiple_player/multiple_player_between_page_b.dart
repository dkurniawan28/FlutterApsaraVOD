...
class MultiplePlayerBetweenPageB extends StatefulWidget {
  ...
  @override
  _MultiplePlayerBetweenPageBState createState() => _MultiplePlayerBetweenPageBState();
}

class _MultiplePlayerBetweenPageBState extends State<MultiplePlayerBetweenPageB> {
