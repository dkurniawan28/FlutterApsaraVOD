...
import 'package:flutter_testaliplayer/model/definition_model.dart';
...
import 'package:flutter_testaliplayer/widget/aliyun_regin_dropdown.dart';
...
class _MpsPagePageState extends State<MpsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.only(left: 15.0, top: 5.0, right: 15.0, bottom: 0),
        child: Column(
          children: [
            //Region
            Container(
            ...
            _selectDefinition == 1
                ? Expanded(
                    child: GridView.builder(
                        ...
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3, mainAxisSpacing: 2.0, crossAxisSpacing: 2.0, childAspectRatio: 3),
                        itemBuilder: (BuildContext context, int index) {
                          return CheckboxListTile(
                            ...
                            onChanged: (value) {
                              if (value != null) {
                                _selectedDefinition.add(_definitionList![index].title);
                              } else {
                                _selectedDefinition.remove(_definitionList![index].title);
                              }
                              setState(() {
              ...
              children: [
                RaisedButton(
                  ...
                  onPressed: () {
                    ...
                    NetWorkUtils.instance.getHttp(HttpConstant.GET_MPS, successCallback: (data) {
                      ...
                      if (_akInfo != null) {
                        ...
                        _accessKeySecretController.text = _akInfo["AccessKeySecret"];
                        _securityTokenController.text = _akInfo["SecurityToken"];
                      }
                      var map = {
                        ...
                        DataSourceRelated.PLAYDOMAIN_KEY: _playDomainController.text,
                        DataSourceRelated.AUTHINFO_KEY: _authInfoController.text,
                        DataSourceRelated.HLSURITOKEN_KEY: _hlsUriTokenController.text,
