  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.separated(
          separatorBuilder: (BuildContext context, int index) => Divider(height: 3.0, color: Colors.black),
            ...
            return Column(
              children: [
                InkWell(
                  ...
                  onTap: () {
                    Map<String, String> dataSourcecMap = {DataSourceRelated.URL_KEY: _localFileList[index]};
