...
class _AuthPageState extends State<AuthPage> {
  TextEditingController _vidController = TextEditingController.fromValue(TextEditingValue(text: DataSourceRelated.DEFAULT_VID));
              ...
              children: [
                RaisedButton(
                  ...
                  onPressed: () {
                    ...
                    NetWorkUtils.instance.getHttp(HttpConstant.GET_AUTH, params: params, successCallback: (data) {
                      ...
                      var map = {
                        ...
                        DataSourceRelated.PREVIEWTIME_KEY: _previewController.text,
