...
import 'package:flutter_testaliplayer/page/auth_page.dart';
// import 'package:flutter_testaliplayer/page/download_page.dart';
import 'package:flutter_testaliplayer/page/live_shift_page.dart';
import 'package:flutter_testaliplayer/page/multiple_player_test.dart';
import 'package:flutter_testaliplayer/page/setting_page.dart';
import 'package:flutter_testaliplayer/page/sts_page.dart';
import 'package:flutter_testaliplayer/page/url_page.dart';
import 'package:flutter_testaliplayer/page/video_grid_page.dart';
...
class _MyAppState extends State<HomePage> {
  ...
  List titleArr = ['URL播放', 'STS播放', 'AUTH播放', '播放列表演示(VID)', '播放列表演示(URL)', '断点下载', '多实例播放器', '本地文件', '直播时移'];
