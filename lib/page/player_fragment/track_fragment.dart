...
class TrackFragmentState extends State<TrackFragment> {
  ...
  Map extSubTitleMap = {
    "cn": "https://alivc-player.oss-cn-shanghai.aliyuncs.com/6137c3dedd00a00547a1e8e5e3355369.vtt",
    "en": "https://alivc-player.oss-cn-shanghai.aliyuncs.com/6b4949a8c3950f8aa76f1fed6730e525.vtt"
  };
                        ...
                        onTap: () {
                          if (element.title == '---- 外挂字幕 ----') {
                            ...
                            if (_previewLastSubtitleIndex != e.value) {
                              widget.fAliplayer.selectExtSubtitle(_previewLastSubtitleIndex, false);
                            }
                            ...
                            widget.fAliplayer.selectExtSubtitle(e.value, !isSelected);
  ...
  prepared() {
    if (_list != null && _list?.length != null) {
  ...
  _initData() {
    _list = [
      TrackUIModel(isOpen: false, title: '---- VIDEO ----', selValue: -1, children: []),
      TrackUIModel(isOpen: false, title: '---- AUDIO ----', selValue: -1, children: []),
      TrackUIModel(isOpen: false, title: '---- SUBTITLE ----', selValue: -1, children: []),
      TrackUIModel(isOpen: false, title: '---- VOD ----', selValue: -1, children: []),
      TrackUIModel(isOpen: false, title: '---- 外挂字幕 ----', selValue: -1, children: []),
    ];
  }
