...
class _PlayConfigFragmentState extends State<PlayConfigFragment> {
  TextEditingController _mStartBufferDurationController = TextEditingController();
  TextEditingController _mHighBufferDurationController = TextEditingController();
  TextEditingController _mMaxBufferDurationController = TextEditingController();
  TextEditingController _mMaxDelayTimeController = TextEditingController();
  TextEditingController _mNetworkTimeoutController = TextEditingController();
  TextEditingController _mNetworkRetryCountController = TextEditingController();
  TextEditingController _mMaxProbeSizeController = TextEditingController();
  TextEditingController _mReferrerController = TextEditingController();
  TextEditingController _mHttpProxyController = TextEditingController();
  ...
  _getPlayerConfig() async {
    ...
    _mStartBufferDurationController = TextEditingController.fromValue(TextEditingValue(
      text: _configMap['mStartBufferDuration'].toString(),
    ));
    _mHighBufferDurationController = TextEditingController.fromValue(TextEditingValue(
      text: _configMap['mHighBufferDuration'].toString(),
    ));
    _mMaxBufferDurationController = TextEditingController.fromValue(TextEditingValue(
    ...
    _mNetworkTimeoutController = TextEditingController.fromValue(TextEditingValue(
      text: _configMap['mNetworkTimeout'].toString(),
    ));
    _mNetworkRetryCountController = TextEditingController.fromValue(TextEditingValue(
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      var configMap = {
                        'mStartBufferDuration': _mStartBufferDurationController.text,
                        'mHighBufferDuratio': _mHighBufferDurationController.text,
                        'mMaxBufferDuration': _mMaxBufferDurationController.text,
                        'mMaxDelayTime': _mMaxDelayTimeController.text,
                        'mNetworkTimeout': _mNetworkTimeoutController.text,
                        'mNetworkRetryCount': _mNetworkRetryCountController.text,
