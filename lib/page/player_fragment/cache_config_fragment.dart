...
class _CacheConfigFragmentState extends State<CacheConfigFragment> {
  TextEditingController _mMaxSizeMBController = TextEditingController.fromValue(TextEditingValue(text: "500"));
  TextEditingController _mMaxDurationSController = TextEditingController.fromValue(TextEditingValue(text: "100"));
