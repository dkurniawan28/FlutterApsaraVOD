...
// class _AliyunSliderState extends State<AliyunSlider> with TickerProviderStateMixin {
...
//   @override
//   void updateRenderObject(BuildContext context, _RenderAliyunSlider renderObject) {
//     renderObject
//       ..value = value!
//       ..bufferValue = bufferValue!
//       ..divisions = divisions!
...
//         canvas.drawRRect(RRect.fromLTRBXY(trackActive, trackTop, trackRight, trackBottom, 1.0, 1.0), paint);
//       } else {
//         canvas.drawRRect(RRect.fromLTRBXY(trackActive, trackTop, buffingRight, trackBottom, 1.0, 1.0), paint);
//       }
