...
// import 'package:flutter_testaliplayer/model/downloader_model.dart';
...
//   final TextEditingController _vidController = TextEditingController.fromValue(TextEditingValue(text: DataSourceRelated.DEFAULT_VID));
...
//   final TextEditingController _securityTokenController = TextEditingController();
...
//                                 TrackInfoModel trackInfoModel = _downloadModel.trackInfos[_selectedIndex];
//                                 CustomDownloaderModel customDownloaderModel = CustomDownloaderModel(
//                                     videoId: _downloadModel.videoId,
//                                     title: _downloadModel.title,
//                                     coverUrl: _downloadModel.coverUrl,
//                                     index: trackInfoModel.index,
//                                     vodDefinition: trackInfoModel.vodDefinition,
...
//     _netWorkUtils.getHttp(HttpConstant.GET_AUTH, params: params, successCallback: (data) {
...
//     if (_downloadModel == null || _downloadModel.trackInfos == null || _downloadModel.trackInfos.length == 0) {
//       return Expanded(
//         child: SizedBox(
//           width: 10.0,
//           height: 20.0,
...
//             String size = FormatterUtils.getFileSizeDescription(_trrackInfoModel.vodFileSize);
//             String title = _trrackInfoModel.vodDefinition + "\{${_trrackInfoModel.vodFormat}, $size\}";
//             return Row(
//               children: [
//                 Radio(
//                     value: index,
