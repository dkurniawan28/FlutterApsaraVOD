...
class DBUtils {
  ...
  static Future<void> openDB() async {
    ...
    _dataBase = await openDatabase(_dbPath, version: 1, onCreate: (Database db, int version) async {
  ...
  Future<void> update(Map<String, dynamic> value) async {
    ...
    await _dataBase?.update(TABLE_NAME, value, where: where, whereArgs: whereArgs);
  }
